...
/**
 * class contains the functionality for managing the Inventory,
 * ShoppingCart,
...
public class StoreManager {
    ...
    /**
     * Unique cartID used to identify the user of the system assigned to per
     * StoreView for a new,
    ...
    public int assignNewCartID() {
        CART_ID++;
        // Each increment of cartID adds a new instance of a ShoppingCart to the
        // cartArrayList.
     ...
     * @param quantity int : the quantity to be transferred between shopping cart
     *                 and inventory
     */
    ...
    /**
     * Return all products in the shopping cart back to the inventory upon
     * terminating without checkout.
     */
    public void clear() {
     ...
     *
     * @return ArrayList<Product> : list of integer array representing a product
     *         item
     */
