...
/**
 * Interface defining basic behaviour that are a requirement of any class that
 * manage a Product-Stock collection.
 */
public interface ProductStockContainer {
     ...
     * @return int : the quantity value of a specific product available in the
     *         container
     */
