...
/**
 * class keeps track of the state of the user's shopping cart.
 */
public class ShoppingCart implements ProductStockContainer {
     ...
     *
     * @param product  Product : the product
     * @param quantity int : value for a specified amount of product to be added to
     *                 shopping cart
     */
    @Override
     ...
     *
     * @param product  Product : the product
     * @param quantity int : value for a specified amount of product to be removed
     *                 to shopping cart
     */
    @Override
